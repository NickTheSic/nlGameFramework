...
// binary
void read_entire_file(const char* const filename, file_contents* const contents, nl_bump_allocator* allocator);
...
void load_shader_from_data(const char* filename, file_contents* const contents, nl_bump_allocator* allocator);
void load_sound_from_data(const char* filename, file_contents* const contents, nl_bump_allocator* allocator);
