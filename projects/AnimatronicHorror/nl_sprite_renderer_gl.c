...
global_variable unsigned char has_been_initialized = {0};
#define NL_SPRITE_RENDERER_INIT_CHECK() if (has_been_initialized == 0) {DO_ONCE(NL_LOG("Have not Initialized the Sprite Renderer!")); return; }
