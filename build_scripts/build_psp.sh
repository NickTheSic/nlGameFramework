...
FLAGS="-Wall -Wextra -g -Wl,-zmax-page-size=128 -O2"
...
if [ ! -d "_build/psp/$1-dbg" ]
then
mkdir "_build/psp/$1-dbg"
fi
...
pack-pbp $OUTPUT/$1-dbg/EBOOT.PBP $OUTPUT/PARAM.SFO NULL NULL NULL NULL NULL $OUTPUT/$1.elf NULL
pack-pbp $OUTPUT/$1/EBOOT.PBP $OUTPUT/PARAM.SFO NULL NULL NULL NULL NULL $OUTPUT/$1.prx NULL